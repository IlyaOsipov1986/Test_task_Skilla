    ...
    return (
        <>
            <tr onMouseEnter={() => setIsHovered(true)}
                ...
                className="hover:bg-[#d4dff3]/20 hover:cursor-pointer h-16 border-b border-gray-200"
            >
                <td className="w-14 py-2 px-4">
                    <StatusCall
                        status={item.in_out}
                    />
                </td>
                <td className="w-20 py-2 px-4 text-[#122945] font-light text-base">
                ...
                <td className="w-80 py-2 px-4 text-[#122945] font-light text-base">
                    <NumberCall
                        dataForNumber={item}
                    />
                </td>
                <td className="w-52 max-w-16 py-2 px-4 text-[#5E7793] font-light text-base truncate">
                    {item.source}
                </td>
                <td className="w-96 py-2 px-4">
                    <GradeStatus
                        gradeIndex={item.gradeIndex}
                    /> 
                </td>
                <td className="w-24 py-2 px-4 text-[#122945] font-light text-base text-right">
